	...
	public class FallsNotReported_Pie extends Application {  
	   @Override 
	   public void start(Stage stage) { 
	      //Preparing ObservbleList object         
	      ObservableList<PieChart.Data> pieChartData = FXCollections.observableArrayList(
	         new PieChart.Data("Not Reported", 10), 
	         new PieChart.Data("Reported", 28)); 
	 ...
	 GridPane gridPane = new GridPane();    
	      ...
	      pieChart.setTitle("Falls Reported or not Reported but happened"); 
